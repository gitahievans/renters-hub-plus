...
const PropertyDetails = () => {
    ...
    const displayedFeatures = showAllFeatures ? keyFeatures : keyFeatures.slice(0, 5);
    ...
    return (
        <div className='min-h-screen bg-slate-100 flex flex-col gap-8 py-4 px-2 lg:px-10 '>
            ...
            <article >
                ...
                <button
                    className='text-accent-color hover:text-accent-color cursor-pointer underline mt-2'
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='md:w-1/3'>
                    <Textarea label='Leave a comment' radius='md' size='xl' />
                </div>
            </div>


            <div className="w-full p-2 flex flex-col gap-2">
                <h1 className='text-2xl font-medium'>Location on map</h1>
                <iframe
