                ...
                <form action="#" className="space-y-8">
                    <div className='flex items-center w-full gap-2'>
                        <div className='flex-1'>
                            ...
                            <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 hover:bg-gray-200 focus:bg-gray-50 transition-all duration-500 " placeholder="First name" required />
                        </div>
                        <div className='flex-1'>
                            <label htmlFor="email" className="block mb-2 text-sm font-semibold text-gray-900 ">Last Name</label>
                            <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 hover:bg-gray-200 focus:bg-gray-50 transition-all duration-500 " placeholder="Last name" required />
                        </div>
                    </div>
                    <div>
                    ...
                    <div className={`flex items-center justify-between w-full `}>
                        ...
                        <button type="button" className="btn flex items-center px-5 text-sm font-medium text-center rounded-3xl sm:w-fit  focus:ring-4 focus:outline-none h-fit bg-[#16be45] hover:bg-[#272e40] text-white "><Image src={whatsapp} alt='Whatsapp' className='w-6 md:w-12' /><span className='text-sm'>WhatsApp</span></button>
                    </div>
                </form>
