    ...
    return (
        ...
        <div className={`max-w-sm xl:max-w-md bg-white border border-gray-200 rounded-lg shadow  dark:border-gray-700 `}>
            ...
            <div className={`p-${twoColumns ? 2 : 5} flex flex-col gap-${twoColumns ? 2 : 3} p-4`}>
                <h1 className={`mb-2 ${twoColumns ? 'text-[12.5px] font-semibold uppercase' : null} text-xl md:text-2xl font-bold tracking-tight text-black`}>Three Bedroom houses near Oloibon</h1>
                <div className='flex gap-2 items-center'>
                    <Image src={location} alt='pin-location' className='w-8' />
