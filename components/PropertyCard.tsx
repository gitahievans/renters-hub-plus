...
const PropertyCard = () => {
  return (
      ...
      <div className="max-w-sm xl:max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
              <Image className="rounded-t-lg" src={house} alt="House" />
          </a>
          <div className="p-5">
              <Link href="#">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">THREE BEDROOM HOUSES NEAR OLOIBON</h5>
              </Link>
